...
export const HomePage = () => {
    ...
    return (
        <>
            ...
            <IconButton onClick={handleClick8}>전선배상세1</IconButton>
            <BlueButton onClick={handleClick2}>요시키상</BlueButton>
            <BlueButton onClick={handleClick7}>요시키상세1</BlueButton>
            <BlueButton onClick={handleClick3}>카공족1</BlueButton>
            <BlueButton onClick={handleClick4}>카공족2</BlueButton>
            <BlueButton onClick={handleClick5}>카공족상세1</BlueButton>
            <BlueButton onClick={handleClick6}>카공족상세2</BlueButton>
        </>
    );
};
